...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_jquery__ = __webpack_require__(287);
...
var ApontamentoPage = (function () {
    ...
    ApontamentoPage.prototype.changeColor = function () {
    };
    ...
    ApontamentoPage.prototype.Apontar = function () {
        var data = new Date();
        var horas = data.getHours();
        var minutos = data.getMinutes();
        var c = 0;
        __WEBPACK_IMPORTED_MODULE_3_jquery__(".row-apontamento").each(function () {
            var row = __WEBPACK_IMPORTED_MODULE_3_jquery__(this);
